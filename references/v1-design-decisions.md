...
Status: historical design decisions and discussion notes. The agreed design is now consolidated in `v1-specification.md`, which is authoritative if historical wording here conflicts. Remaining implementation gaps are grouped in that specification.
